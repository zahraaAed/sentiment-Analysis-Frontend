...
const Header = () => {
  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-content p-6">
 ...
 <li>
    <NavLink to="/contactus" className="text-white font-bold hover:text-pink-700 transition-all duration-200 font-sans" activeClassName="active">Contact</NavLink>
      ...
      <button className="bg-transparent hover:bg-white text-white sm:text-black cursor-pointer hover:text-pink-700 border border-white sm:border-black hover:border-content font-bold py-2 px-4 sm:py-1 sm:px-2 md:py-1.5 md:px-2.5 lg:py-2 lg:px-4 font-sans sm:rounded-md lg:rounded-full">
  <Link to="/login">Sign in</Link>
      ...
      <div className="block lg:hidden">
        <button
          ...
          className="flex items-center px-3 py-2 border rounded text-white border-pink-700 hover:text-pink-700 hover:border-white"
        >
          {isOpen ? (
...
>
 Contact us
      ...
      <div className="lg:hidden items-center justify-center space-x-5 mb-8 mx-8 mt-4">
