  ...
  return (
    <div>
      ...
      <div className="flex justify-center mt-12">
        <img
          src={Analysis}
          className="w-1/2 h-auto px-4 align-middle rounded-lg "
        />
      </div>
      <input
        type="text"
      ...
      <div className="flex flex-col justify-center items-center h-screen">
        {chartData && (
          <Bar
            ...
            data={chartData}
            options={options}
            className=" mt-16 mx-auto block w-5/6 h-32 px-3 py-2 shadow-lg shadow-indigo-500/50 bg-blend-difference placeholder-gray-500 focus:outline-none focus:ring-pink-500 focus:border-pink-500 sm:text-lg"
          />
        )}
