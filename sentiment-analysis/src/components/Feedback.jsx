...
const Feedback = () => {
  ...
  <p className="text-pink-700 border border-white text-2xl mb-8 font-bold py-1 px-2 sm:py-1 sm:px-2 md:py-1 md:px-2 lg:py-1 lg:px-2 font-sans rounded-full animate-bounce">
