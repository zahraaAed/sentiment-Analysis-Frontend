...
const Feedback = () => {
  ...
  return (
    <div className="relative ">
      ...
      <button onClick={prevSlide} className="absolute left-0 top-1/2 transform -translate-y-1/2 z-10 p-2 bg-purple-200 rounded-full mt-16 mx-16 md:mx-6 sm:mx-2 sm:block button-feedback">
  &lt;
</button>
<button onClick={nextSlide} className="absolute right-0 top-1/2 transform -translate-y-1/2 z-10 p-2 bg-purple-200 rounded-full mt-16 mx-16 sm:mx-2  sm:block button-feedback-right">
  &gt;
</button>
