...
const About=()=> {
  return (
    <div className="w-full p-10 px-6 mt-6 text-xl lg:text-3xl text-white flex flex-col lg:flex-row justify-center items-center">
      <img src={sentiment} className='w-full lg:w-1/2 px-8 mb-8 lg:mb-0' alt="Sentiment Analysis" />
      <div className="w-full lg:w-1/2 p-10 px-6 text-xl lg:text-4xl text-white flex flex-col justify-center">
        ...
        <p className="text-content mb-4">Sentiment analysis empowers you to decipher the emotions and opinions expressed about your brand, products, and services across various channels.</p>
